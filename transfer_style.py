...
if __name__ == '__main__':
    ...
    parser.add_argument("-cont_im", "--content_image", required=True, help="path to content image")
    parser.add_argument("-style_im", "--style_image", required=True, help="path to style image")
    parser.add_argument("-p", "--prompt", default='*')
    parser.add_argument("-str", "--strength", default=0.7)
    parser.add_argument("-s", "--steps", default=70)
    ...
    model.embedding_manager.load('shrek_embeddings.pt')
    model = model.to(device)
    
    main(prompt = args.prompt, \
     content_dir = args.content_image, \
     style_dir = args.style_image, \
